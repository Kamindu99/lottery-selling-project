 ...
 *
 */
import logoDark from 'assets/images/mainlogo.jpg';
...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
     ...
     */
    <>
      <img src={theme.palette.mode === ThemeMode.DARK ? logoDark : logo} alt="The Hummingbird Project" width="200" style={{ marginTop: '9%' }} />
